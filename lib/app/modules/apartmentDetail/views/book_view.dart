                    ...
                    child: ClipRRect(
                      ...
                      child: SfDateRangePicker(
                        ...
                        onSelectionChanged:
                          ...
                          controller.startDate.value = DateFormat('yyyy-MM-dd')
                              .format(args.value.startDate)
                              .toString();
                          controller.endDate.value = DateFormat('yyyy-MM-dd')
                              .format(args.value.endDate != null
                                  ? args.value.endDate
                                  : DateTime.now())
                              .toString();
                        },
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    const ListTile(
                                      ...
                                      subtitle: Text(
                                          "free cancellation before 15:00 on 27 sep. cancel before check in "),
                                    ),
                                    const ListTile(
                                      title: Text(
                                        "Ground Rules",
                                    ...
                                    const ListTile(
                                      subtitle: Text(
                                          "By selecting the button, i agree to the booking term"),
                                    ),
                                    Container(
