    ...
    return Scaffold(
      ...
      bottomNavigationBar:Obx(() =>BottomNavigationBar(
          ...
          const BottomNavigationBarItem(icon:FaIcon(FontAwesomeIcons.house),label: "Home"),
            if(Get.find<GlobalController>().isLogIn.value)
          const BottomNavigationBarItem(icon:FaIcon(FontAwesomeIcons.book),label: "Booking"),
          const BottomNavigationBarItem(icon:FaIcon(FontAwesomeIcons.solidHeart),label: "Saved"),
          const BottomNavigationBarItem(icon:FaIcon(FontAwesomeIcons.solidUser),label: "Account"),
      ])
      )
    );
  }
