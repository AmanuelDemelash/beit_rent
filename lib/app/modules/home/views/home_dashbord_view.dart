...
class ApartmentListView extends StatelessWidget {
  const ApartmentListView({super.key, required this.property});
                    ...
                    child: CarouselSlider.builder(
                        ...
                        options: CarouselOptions(
                          ...
                          onPageChanged: (index, reason) =>
                              Get.find<HomeController>().carouselIndex.value =
                                  index,
                        ))),
                Positioned(
                  bottom: 20,
...
class ApartmentHorizontalCard extends StatelessWidget {
  const ApartmentHorizontalCard({super.key, required this.property});
  final Property property;
  @override
  Widget build(BuildContext context) {
    return Card(
